...
def phrases():
    ...
    # シールあそび
    P.update(['すきな シールを はろう！', 'しゃしんを とったよ！', 'おへや', 'こうえん', 'うみ', 'うちゅう', 'もう ないよ'])
    # しりとり
    ...
    # つみき
    P.update(['つみきを えらんで うえに つもう', 'おっこちた！ もういちど', 'ぜんぶ つめた！ すごい！'])
    # ボールころがし
    P.update(['せんを かいて ボールを カゴまで ころがそう', 'ころがす！', 'カゴに はいった！ やったね！',
              'おっこちた。 せんを かきなおして もういちど', 'とまっちゃった。 せんを かきなおして もういちど', 'せんを かいてね'])
    return sorted(P)
